 ...
 */
// service/ChatService.java — Manages user sessions, rooms, and message routing with indexed lookups
...
public class ChatService {
    ...
    private ConcurrentHashMap<String, OnlineStatus> onlineStatusMap; // ConcurrentHashMap = O(1) thread-safe status check
    ...
    public User registerUser(String name) {
        ...
        users.put(id, user);
        onlineStatusMap.put(id, OnlineStatus.OFFLINE);
        notificationManager.updateStatusCache(id, OnlineStatus.OFFLINE);
    ...
    public void setUserStatus(String userId, OnlineStatus status) {
        ...
        if (user != null) {
            ...
            // WHY: O(1) status update in concurrent map
            onlineStatusMap.put(userId, status);
