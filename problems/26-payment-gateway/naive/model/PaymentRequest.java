...
public class PaymentRequest {
    private String idempotencyKey;   // private = only this class can read/write; hides internals
    private double amount;           // private = external code must use getters to access
