...
class DisplayBoard implements ParkingObserver { // implements = fulfills the ParkingObserver contract
    private final String boardName;            // final = name never changes once set
