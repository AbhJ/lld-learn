...
public class Formatting {
    ...
    public Formatting() { this.styles = new HashSet<>(); this.fontSize = 12; }
    public Formatting(Formatting other) { this.styles = new HashSet<>(other.styles); this.fontSize = other.fontSize; }
