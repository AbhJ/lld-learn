 ...
 */
// Main.java — Demonstrates online auction with linear scan for highest bid
public class Main {
    public static void main(String[] args) {
        System.out.println("=== Online Auction Demo (Naive) ===\n");
        ...
        System.out.println("--- Placing Bids (linear scan for highest each time) ---");
