...
public interface WinnerStrategy {                         // interface = pluggable winner-determination algorithm
    ...
    class HighestBidStrategy implements WinnerStrategy {
        @Override
    ...
    class SecondPriceStrategy implements WinnerStrategy {
        @Override
        public WinnerResult determineWinner(List<Bid> bids, double reservePrice) {
            if (bids.isEmpty()) return null;
            if (bids.size() == 1) {
