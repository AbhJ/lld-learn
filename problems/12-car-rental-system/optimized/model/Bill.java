...
public class Bill {
    private static int counter = 0;       // shared ID generator across all bills
    private String billId;                // unique bill identifier
    private Reservation reservation;      // the reservation this bill is for
    private LocalDateTime generatedAt;    // when the bill was created
