...
public class TaskResult {
    ...
    private String taskId;                       // private = only this class manages result data
    ...
    public static TaskResult pending(String taskId) { // static = factory method; no instance needed to create result
        return new TaskResult(taskId, Status.PENDING, null, 0);
    }

    public static TaskResult success(String taskId, String output, long timeMs) {
    ...
    public String toString() {
        return String.format("TaskResult[%s] %s - %s (%dms)",
                taskId, status, output != null ? output : "N/A", executionTimeMs);
    }
}
