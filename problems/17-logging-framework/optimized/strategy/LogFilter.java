...
public abstract class LogFilter {                // abstract = can't instantiate; subclass provides doFilter()
    ...
    protected abstract boolean doFilter(LogMessage message); // abstract = subclass MUST implement its own filtering
}
...
class LoggerNameFilter extends LogFilter {
...
class KeywordFilter extends LogFilter {
