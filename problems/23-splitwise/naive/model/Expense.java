...
public class Expense {
    ...
    private User paidBy;                                  // private = who paid the bill
    private Map<User, Double> shares;                     // private = computed share per participant
    private SplitStrategy strategy;                       // private = algorithm used to compute shares
