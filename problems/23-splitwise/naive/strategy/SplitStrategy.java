...
public interface SplitStrategy {                          // interface = contract for interchangeable split algorithms
    Map<User, Double> split(double totalAmount, List<User> participants, Map<User, Double> params);

    class EqualSplit implements SplitStrategy {            // implements = provides equal-split algorithm
        @Override
    ...
    class PercentageSplit implements SplitStrategy {        // implements = provides percentage-split algorithm
        @Override
        public Map<User, Double> split(double totalAmount, List<User> participants, Map<User, Double> params) {
    ...
    class ExactSplit implements SplitStrategy {             // implements = provides exact-amount split
        @Override
        public Map<User, Double> split(double totalAmount, List<User> participants, Map<User, Double> params) {
