 ...
 */
// Main.java — Demonstrates optimized expense splitting with net balance simplification
import java.util.*;

public class Main {
    public static void main(String[] args) {
        System.out.println("=== Splitwise Demo (Optimized) ===");
        System.out.println("Optimization: Net balance simplification minimizes transactions\n");
        ...
        System.out.println("Added: Dinner $120, Cab $40, Hotel $200");
