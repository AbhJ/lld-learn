 ...
 */
// Main.java — Entry point demonstrating the optimized conference room booking
...
public class Main {
    public static void main(String[] args) {
        System.out.println("=== Conference Room Booking Demo (Optimized - TreeMap per Room) ===");
        ...
        System.out.println("\n--- Book Room (O(log n) conflict check) ---");
