...
class ConcreteSubscriber implements Subscriber { // implements = fulfills the Subscriber contract
    ...
    public String toString() {
        return String.format("Subscriber[%s, filter: %s]", name, filter.getDescription());
    }
}
