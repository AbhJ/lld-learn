...
public class Topic {
    private String name;                         // private = only this class controls topic identity
    private List<Message> messageHistory;         // private = internal message log; exposed via unmodifiable view
