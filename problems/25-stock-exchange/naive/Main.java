 ...
 */
// Main.java — Demonstrates stock exchange with O(n) order matching
public class Main {
    public static void main(String[] args) {
        System.out.println("=== Stock Exchange Demo (Naive) ===\n");
        ...
        System.out.println("\n--- Incoming sell crosses spread (O(n) scan per match) ---");
