 ...
 */
// Main.java — Entry point demonstrating the optimized calendar system
import java.time.LocalDateTime;
import java.util.List;

public class Main {
    public static void main(String[] args) {
        System.out.println("=== Calendar System Demo (Optimized) ===");
        ...
        System.out.println("\n--- Conflict Detection (O(log n) with TreeMap) ---");
